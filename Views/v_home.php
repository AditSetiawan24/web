        ...
        <div class="container about py-5 px-lg-0">
            <div class="row g-5 mx-lg-0">
                ...
                <div class="col-lg-6 about-text wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <a href="<?=base_url('about')?>" class="btn btn-primary py-3 px-5">Explore More</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-4">
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item p-4">
                        ...
                        <a class="btn-slide mt-2" href="<?=base_url('services')?>"><i class="fa fa-arrow-right"></i><span>Read More</span></a>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="service-item p-4">
                        ...
                        <p>Stet stet justo dolor sed duo. Ut clita sea sit ipsum diam lorem diam.</p>
                        <a class="btn-slide mt-2" href="<?=base_url('price')?>"><i class="fa fa-arrow-right"></i><span>Read More</span></a>
                    </div>
                </div>
            </div>
        </div>
